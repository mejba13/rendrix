  ...
  return (
    <div className="min-h-screen bg-black flex relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-30%] left-[-10%] w-[500px] h-[500px] rounded-full bg-orange-600/15 blur-[100px] animate-pulse delay-700" />
        <div className="absolute top-[50%] right-[40%] w-[300px] h-[300px] rounded-full bg-amber-500/10 blur-[80px] animate-float" />
          ...
          <div className="space-y-8 max-w-lg">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.05] border border-white/[0.08]">
                ...
                <span className="text-sm text-white/70">Start your free trial today</span>
              </div>
              ...
              <p className="text-lg text-white/50 leading-relaxed">
                Join thousands of successful merchants building their
                dream stores with Rendrix.
              </p>
            </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-8 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/[0.03] backdrop-blur-xl border border-white/[0.08] rounded-3xl p-8 shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <button
                  type="button"
                  className="flex items-center justify-center gap-2 h-11 px-4 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white/80 hover:bg-white/[0.08] hover:border-white/[0.12] transition-all duration-200"
                >
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        id="firstName"
                        placeholder="John"
                        className="h-11 pl-10 bg-white/[0.04] border-white/[0.08] text-white placeholder:text-white/30 rounded-xl focus:bg-white/[0.06] focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all text-sm"
                        {...register('firstName')}
                      />
                    </div>
                    {errors.firstName && (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-11 pl-10 pr-10 bg-white/[0.04] border-white/[0.08] text-white placeholder:text-white/30 rounded-xl focus:bg-white/[0.06] focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all text-sm"
                      {...register('password')}
                    />
                    <button
                      type="button"
                    ...
                    <div className="grid grid-cols-2 gap-1 mt-2">
                      {passwordRequirements.map((req) => (
                        <div key={req.label} className="flex items-center gap-1.5">
                          <div className={`w-3 h-3 rounded-full flex items-center justify-center ${req.met ? 'bg-green-500/20' : 'bg-white/[0.05]'}`}>
                            {req.met && <Check className="w-2 h-2 text-green-500" />}
                          </div>
                          <span className={`text-xs ${req.met ? 'text-green-400' : 'text-white/40'}`}>
                            {req.label}
                          </span>
                        </div>
                      ))}
                ...
                <Button
                  type="submit"
                  className="w-full h-11 rounded-xl text-base font-medium relative overflow-hidden group"
                  disabled={isLoading}
                  style={{
          ...
          {/* Mobile Footer */}
          <p className="lg:hidden text-center text-xs text-white/30 mt-6">
            &copy; 2025 Rendrix. All rights reserved.
          </p>
        </div>
      </div>
