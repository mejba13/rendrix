    ...
    <div className="relative overflow-hidden rounded-2xl bg-white/[0.02] border border-white/[0.06]">
      ...
      <div className="relative flex flex-col items-center justify-center py-20 px-6">
        <div className="relative mb-6">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500/20 to-violet-500/10 flex items-center justify-center">
        ...
        <h3 className="text-xl font-semibold text-white mb-2">No refunded orders</h3>
        <p className="text-white/50 text-center max-w-md mb-6">
          Orders that have been refunded will appear here. Refunds are linked to original orders for tracking and audit purposes.
        </p>
...
export default function RefundedOrdersPage() {
  ...
  const stats = React.useMemo(() => {
    if (!data?.data) return { total: 0, totalRefunded: 0, fullRefunds: 0, partialRefunds: 0 };
    const totalRefunded = data.data.reduce((sum, o) => sum + o.total, 0);
    return {
      total: data.meta.total,
      totalRefunded,
      fullRefunds: data.data.length, // Simplified - would need actual refund data
      partialRefunds: 0,
    };
  }, [data]);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        <div className="w-16 h-16 rounded-2xl bg-white/[0.06] flex items-center justify-center">
          <RotateCcw className="w-8 h-8 text-white/40" />
        </div>
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-purple-500/20 to-violet-500/10 flex items-center justify-center ring-1 ring-purple-500/20">
            <RotateCcw className="w-6 h-6 text-purple-400" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-white tracking-tight">Refunded Orders</h1>
            <p className="text-white/50 text-sm mt-0.5">
              Refund amounts, reasons, and timestamps linked to original orders
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <>
            <BentoCard
              ...
              subValue="Total refunds processed"
            ...
            <BentoCard
              ...
              subValue="Amount returned to customers"
            ...
            <BentoCard
              icon={CreditCard}
              label="Full Refunds"
              value={stats.fullRefunds}
              subValue="Complete order refunds"
            ...
            <BentoCard
              ...
              subValue="Partial amount refunded"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <InfoCard
          ...
          description="View refund reasons and supporting documentation"
          gradient="from-purple-500 to-violet-500"
          delay={200}
        />
        <InfoCard
          ...
          description="Track processing dates and completion status"
          gradient="from-blue-500 to-cyan-500"
          delay={250}
        />
        <InfoCard
          ...
          description="Linked to original payment transactions"
